# Chapter 120: Saliency Maps для Trading

## Описание

Карты значимости для визуализации важных временных паттернов.
...
1. **Deep Inside Convolutional Networks: Visualising Image Classification Models**
